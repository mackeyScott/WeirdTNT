...
public class OTowerTntEntity extends TntEntity {
    public OTowerTntEntity(World world, double x, double y, double z, @Nullable LivingEntity igniter) {
        super(world, x, y, z, igniter);
        this.setFuse(80);
    }

    public OTowerTntEntity(EntityType<? extends TntEntity> type, World world) {
        super(type, world);
    }
